...
namespace ProjetAvengers.Controllers.Orange
{
    ...
    public class Super_VilainController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Super_Vilain>>> GetSuper_Vilains()
        {
            return await _context.Super_Vilains.ToListAsync();
        }
        ...
        {
            var super_Vilain = await _context.Super_Vilains.FindAsync(id);
        ...
        {
            _context.Super_Vilains.Add(super_Vilain);
            await _context.SaveChangesAsync();
        ...
        public async Task<ActionResult<Super_Vilain>> DeleteSuper_Vilain(int id)
        {
            ...
            _context.Super_Vilains.Remove(super_Vilain);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.Super_Vilains.Any(e => e.Id == id);
        }
    }
}
